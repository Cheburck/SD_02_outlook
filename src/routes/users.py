...
async def get_user_by_login(login: str, db: Database = Depends(get_db)):
...
async def search_users(firstName: str = None, lastName: str = None, db: Database = Depends(get_db)):
